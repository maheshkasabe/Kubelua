...
Kubelua is a simple client library to access the Kubernetes API. It does not abstract much from the
API, but provides some convenience functions for quick scripting.
